<template>
  <div class="home">
      ...
      <BlogPost v-else :post="post" v-for="(post,index) in blogPostsFeed" :key="index"/>
...
export default {
  ...
  data() {
    return {
        welcomeScreen:{
            title:"Welcome!",
            blogPost:"Weekly blog articles with all things programming including HTML, CSS, JavaScript and more Register to never miss a post",
            welcomeScreen:true,
            photo:"coding"
        },
